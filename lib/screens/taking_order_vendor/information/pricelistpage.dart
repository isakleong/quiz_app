...
class PriceListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _takingOrderVendorController.isSuccess.value && _takingOrderVendorController.pricelistdir.isEmpty ? Center(
            child: Column(
        ...
        Column( 
          children: [
            ...
            Obx(() => Expanded(
                        ...
                        child: Align(
                          ...
                          child: InkWell(
                            onTap: () async {
                              ...
                              if (await File("${_takingOrderVendorController.productdir}/${_takingOrderVendorController.activevendor.toLowerCase()}/${filedir.replaceAll("%20", " ")}").exists()) {
                                if (ext == "jpg" || ext == "jpeg") {
                  ...
                  itemCount: _takingOrderVendorController.isSuccess.value == false
                      ? 10
                      : _takingOrderVendorController.pricelistdir.isEmpty
                          ? 0
                          : _takingOrderVendorController.pricelistdir.length,
