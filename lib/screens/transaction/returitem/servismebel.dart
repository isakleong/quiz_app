    ...
    return Column(
      children: [
          ...
          child: Container(
            ...
            child: TypeAheadField(
              textFieldConfiguration: TextFieldConfiguration(
                controller: _takingOrderVendorController.servismebelfield.value,
              ...
              onSuggestionSelected: (suggestion) {
                _takingOrderVendorController.servismebelfield.value.text =
                    suggestion;
        ...
        NoInputRetur(
            ...
            isHorizontal:
                _takingOrderVendorController.servismebelhorizontal.value,
            description:
