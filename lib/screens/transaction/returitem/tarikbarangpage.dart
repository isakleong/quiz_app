    ...
    return Column(
      children: [
          ...
          child: Container(
            ...
            child: TypeAheadField(
              textFieldConfiguration: TextFieldConfiguration(
                controller: _takingOrderVendorController.tarikbarangfield.value,
              ...
              onSuggestionSelected: (suggestion) {
                _takingOrderVendorController.tarikbarangfield.value.text =
                    suggestion;
        ...
        NoInputRetur(
            ...
            isHorizontal:
                _takingOrderVendorController.tarikbaranghorizontal.value,
            description:
